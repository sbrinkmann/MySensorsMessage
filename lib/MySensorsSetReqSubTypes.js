...
MySensorsSetReqSubTypes.V_DIRECTION = new MySensorsSetReqSubTypes("V_DIRECTION", 10, "Wind direction 0-360 (degrees)	S_WIND");
...
MySensorsSetReqSubTypes.V_TEXT = new MySensorsSetReqSubTypes("V_TEXT", 47, "Text message to display on LCD or controller device	S_INFO");
MySensorsSetReqSubTypes.V_CUSTOM = new MySensorsSetReqSubTypes("V_CUSTOM", 48, "Custom messages used for controller/inter node specific commands, preferably using S_CUSTOM device type.	S_CUSTOM");
MySensorsSetReqSubTypes.V_POSITION = new MySensorsSetReqSubTypes("V_POSITION", 49, "GPS position and altitude. Payload: latitude;longitude;altitude(m). E.g. '55.722526;13.017972;18'	S_GPS");
MySensorsSetReqSubTypes.V_IR_RECORD = new MySensorsSetReqSubTypes("V_IR_RECORD", 50, "Record IR codes S_IR for playback	S_IR");
MySensorsSetReqSubTypes.V_PH = new MySensorsSetReqSubTypes("V_PH", 51, "Water PH	S_WATER_QUALITY");
MySensorsSetReqSubTypes.V_ORP = new MySensorsSetReqSubTypes("V_ORP", 52, "Water ORP : redox potential in mV	S_WATER_QUALITY");
MySensorsSetReqSubTypes.V_EC = new MySensorsSetReqSubTypes("V_EC", 53, "Water electric conductivity μS/cm (microSiemens/cm)	S_WATER_QUALITY");
MySensorsSetReqSubTypes.V_VAR = new MySensorsSetReqSubTypes("V_VAR", 54, "Reactive power: volt-ampere reactive (var)	S_POWER");
MySensorsSetReqSubTypes.V_VA = new MySensorsSetReqSubTypes("V_VA", 55, "Apparent power: volt-ampere (VA)	S_POWER");
MySensorsSetReqSubTypes.V_POWER_FACTOR = new MySensorsSetReqSubTypes("V_POWER_FACTOR", 56, "Ratio of real power to apparent power: floating point value in the range [-1,..,1]	S_POWER");
MySensorsSetReqSubTypes.V_DURATION = new MySensorsSetReqSubTypes("V_DURATION", 254, "");
MySensorsSetReqSubTypes.V_AUTO = new MySensorsSetReqSubTypes("V_AUTO", 255, "Provides information if the child sensor is set to auto mode or not");
