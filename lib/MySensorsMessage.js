...
const formatStringTemplate = require("string-template")
...
class MySensorsMessage {
	...
	constructor(rawInput) {
		...
		else if (rawInput instanceof String || typeof rawInput === 'string')
		{
		...
		else if (typeof rawInput === 'object')
		{
			...
			this.isAcknowledged = rawInput.isAcknowledged;
	...
	format(formatString) {
		return formatStringTemplate(formatString, this);
	}
