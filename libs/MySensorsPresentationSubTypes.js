...
MySensorsPresentationSubTypes.S_DIMMER = new MySensorsPresentationSubTypes("S_DIMMER", 4, "Dimmable device of some kind", "V_STATUS (on/off), V_DIMMER (dimmer level 0-100), V_WATT");
...
MySensorsPresentationSubTypes.S_WIND = new MySensorsPresentationSubTypes("S_WIND", 9, "Wind sensor", "V_WIND, V_GUST");
...
MySensorsPresentationSubTypes.S_CUSTOM = new MySensorsPresentationSubTypes("S_CUSTOM", 23, "Use this for custom sensors where no other fits.");
MySensorsPresentationSubTypes.S_DUST = new MySensorsPresentationSubTypes("S_DUST", 24, "Dust level sensor", "V_LEVEL, V_UNIT_PREFIX");
